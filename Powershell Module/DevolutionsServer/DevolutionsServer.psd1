...
@{
    ...
    FunctionsToExport = @('Get-DSServerInfo', 'New-DSSession', 'Close-DSSession', 'Get-DSEntries', 'Get-DSEntry', 'Get-DSVaults', 'New-DSCredentialEntry', 'Get-DSEntrySensitiveData', 'Protect-ResourceToHexString', 'Get-DSPamFolders', 'Get-DSPamAccounts')
