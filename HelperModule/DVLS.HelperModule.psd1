#
# Module manifest for module 'DVLS_HelperModule'
#
# Generated by: Eric St-Martin
#
...
@{
    ...
    FunctionsToExport    = @('Start-DVLSSetup', 'New-OfflineDeployment')
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            Tags = 'Devolutions', 'Server', 'DVLS', 'IIS', 'Windows', 'Features'
